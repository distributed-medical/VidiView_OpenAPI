...
public class VidiViewConfigurator
{
    ...
    /// Server information
    /// </summary>
    public ApiHome Home { get; private set; } = null!;

    /// <summary>
    /// Device registration 
    /// </summary>
    public DeviceManager DeviceRegistration { get; private set; } = null!;
    ...
    /// Service hosts
    /// </summary>
    public ServiceHosts ServiceHosts { get; private set; } = null!;
