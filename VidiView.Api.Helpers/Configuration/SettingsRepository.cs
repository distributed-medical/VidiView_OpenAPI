...
public class SettingsRepository
{
    ...
    /// <summary>
    /// Get all settings from the server. The collection is cached locally, so subsequent calls will 
    /// return the cached collection unless forceReload is set to true.
    /// </summary>
    /// <param name="forceReload">Reload settings</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Update the default value of a specific setting
    /// </summary>
    ...
    public async Task<bool> SetDefaultAsync(string key, string value)
    {
        ...
        if (setting.Value != value)
        {
            ...
            settings.UpdateInPlace(updated);
            return true;
        }
