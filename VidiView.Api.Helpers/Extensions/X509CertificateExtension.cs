...
{
    static readonly X509Certificate2 _vidiviewAuthorityCert;
    ...
    static X509CertificateExtension()
    {
        ...
        _vidiviewAuthorityCert = new X509Certificate2(b);
    ...
    public static bool IsVidiViewLicenseCertificate(this X509Certificate2 certificate)
    {
        ...
        chain.ChainPolicy.CustomTrustStore.Add(_vidiviewAuthorityCert); // Add our own root CA here...
        
        bool success = chain.Build(certificate); // This will fail with untrusted root CA (expected)
